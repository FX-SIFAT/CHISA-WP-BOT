const { Client, CommandHandler } = require("wp-heart");
...
const bot = new Client({
    auth: {
        ...
        customPairingCode: (typeof botConfig.customPairingCode === "string" && botConfig.customPairingCode.trim().length > 0)
            ? botConfig.customPairingCode.trim().toUpperCase()
            : null,
